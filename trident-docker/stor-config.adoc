...
Valori validi: `true`, `false`. Il comportamento predefinito può variare in base alla versione di ONTAP e Trident. Impostare esplicitamente per garantire un comportamento coerente.
