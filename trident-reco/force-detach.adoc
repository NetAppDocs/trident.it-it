...
NOTE: È anche possibile utilizzare metodi alternativi per rilevare gli errori dei nodi, come specificato nella sezione <<Integrazione di soluzioni personalizzate per il controllo dello stato dei nodi>> qui sotto.
