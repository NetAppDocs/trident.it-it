...
* *On-premise ONTAP* - Trident supporta la crittografia Kerberos su NFSv3 e le connessioni da Red Hat OpenShift e cluster Kubernetes upstream a volumi ONTAP on-premise.
...
* Assicurati che tutti i volumi che utilizzi con la crittografia Kerberos siano configurati correttamente. Fai riferimento alla sezione Configurazione del dominio di NetApp (pagina 13) del  https://www.netapp.com/media/16398-tr-3580.pdf["NetApp Enhancements e Guida alle Best Practice"^].
...
Configura la policy di esportazione con NFS, NFSv3 e i protocolli di accesso.
