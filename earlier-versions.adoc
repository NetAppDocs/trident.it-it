...
[role="lead"]
Se non si utilizza Trident 26.06, la documentazione per le versioni precedenti è disponibile in base al link:get-help.html["Ciclo di vita del supporto Trident"].
