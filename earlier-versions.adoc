...
[role="lead"]
Se non si utilizza Trident 25,02, la documentazione per le versioni precedenti è disponibile in base a link:get-help.html["Ciclo di vita del supporto Trident"].
