...
| TCP/UDP 111 | outbound | RPCBIND/portmapper | ONTAP-NAS (NFSv3/v4), ANF (NFS) | Obbligatorio per v3; facoltativo per v4 (firewall offload); limitare se si utilizza -only. 
