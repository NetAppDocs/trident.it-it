...
* Risolto il problema delle applicazioni delle macchine virtuali KubeVirt che ricreavano in modo errato i PersistentVolumeClaims durante le operazioni di reverse, reverse resync e resync di AppMirrorRelationship.
