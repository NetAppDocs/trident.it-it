...
A partire dalla release 24,10, Astra Trident viene rinominato Trident (NetApp Trident). Questo rebranding non influisce sulle funzionalità, le piattaforme supportate e l'interoperabilità di Trident.
