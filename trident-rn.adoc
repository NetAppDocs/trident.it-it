...
* Aggiunto il supporto QoS manuale al driver ANF, rendendolo pronto per la produzione in Trident 26.02; questo miglioramento sperimentale è stato introdotto in Trident 25.06.
