...
NOTE: Gli script presenti nel repository Verda vengono forniti così come sono e non sono ufficialmente supportati da NetApp. Il supporto NetApp copre solo il framework degli hook di esecuzione all'interno di Trident Protect.
