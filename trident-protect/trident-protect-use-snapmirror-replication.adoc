...
. Eseguire le operazioni di risincronizzazione inversa descritte in <<Reverse resync a failed over replication>>.
...
* Risincronizzazione inversa della relazione.
* Invertire la replica.


.Fasi
. Eseguire i <<Resync a failed over replication>>passaggi
. Eseguire i <<Reverse resync a failed over replication>>passaggi
