...
* Assicurarsi che esista almeno un VolumeSnapshotClass. Per ulteriori informazioni, consultare link:https://docs.netapp.com/us-en/trident/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"].
...
----
====
Per sapere come definire le applicazioni e ripristinare le VM con Trident Protect, vedi link:trident-protect-kubevirt-vms.html["Proteggi le macchine virtuali KubeVirt con Trident Protect"].
