...
Trident applica le impostazioni di auto-tiering solo al momento della creazione del volume. Le modifiche successive al provisioning non sono supportate in Trident 26.06.
...
== Funzionalità supportate in Trident 26.06

Trident 26.06 supporta le seguenti funzionalità di auto-tiering per Google Cloud NetApp Volumes:
...
== Funzionalità non supportata in Trident 26.06
