...
+
image::../media/aws-eks-01.png[Scheda Componenti aggiuntivi del cluster EKS]

. Vai su *componenti aggiuntivi di AWS Marketplace* e scegli la categoria _storage_.
+
image::../media/aws-eks-02.png[Categoria di archiviazione dei componenti aggiuntivi di AWS Marketplace]
...
+
image::../media/aws-eks-03.png[Selezione della versione del componente aggiuntivo Trident]

. Configurare le impostazioni aggiuntive richieste.
+
image::../media/aws-eks-04.png[Impostazioni di configurazione del componente aggiuntivo Trident]
...
+
image::../media/aws-eks-05.png[Stato attivo del componente aggiuntivo Trident]
...
----
. Continua la configurazione e configura il backend di storage. Per informazioni, vedi link:trident-fsx-storage-backend.html["Configurare il backend di archiviazione"].
