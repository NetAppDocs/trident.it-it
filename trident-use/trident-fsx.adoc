...
** Trident supporta volumi SMB montati solo su pod in esecuzione su nodi Windows. Consultare link:worker-node-prep.html#prepare-to-provision-smb-volumes["Preparatevi al provisioning dei volumi SMB"] per i dettagli.
