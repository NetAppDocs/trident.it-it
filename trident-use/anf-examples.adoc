...
== Considera gli ambienti cloud di Azure (26.06)

A partire dalla versione 26.06, Trident supporta la creazione e la gestione di backend Azure NetApp Files in più ambienti cloud di Azure.
...
| `snapshotDir` | Accesso a `.snapshot` directory | `true`, `false` (Impostato esplicitamente). 
