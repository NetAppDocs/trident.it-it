...
Per un elenco completo dei parametri backend, vedere: link:trident-fsx-storage-backend.html#backend-advanced-configuration-and-examples["Configurazione del backend FSx for NetApp ONTAP"].
