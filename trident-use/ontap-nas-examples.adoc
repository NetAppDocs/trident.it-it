...
A partire dalla versione 25.10, NetApp Trident supportalink:https://docs.netapp.com/us-en/ontap-afx/index.html["Sistemi di archiviazione NetApp AFX"^] . I sistemi di storage NetApp AFX differiscono dagli altri sistemi basati su ONTAP(ASA, AFF e FAS) nell'implementazione del loro livello di storage.
