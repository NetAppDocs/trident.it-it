...
[%collapsible]
====
Per ulteriori informazioni sullo stacco forzato, fare riferimento alink:..trident-get-started/kubernetes-customize-deploy.html["Personalizzare l'installazione dell'operatore Trident"] .
