...
[%collapsible]
====
Per abilitare operazioni simultanee del controller Trident e migliorare il throughput, aggiungi l' `--enable-concurrency`opzione durante l'installazione come mostrato in questo esempio. Per ulteriori informazioni sui driver supportati, vedi il link: https://docs.netapp.com/us-en/trident/trident-use/controller-scalability.html#controller-scalability[Controller Scalability documentation].
