...
NOTE: Questa configurazione funzionava nelle versioni precedenti, ma la piena qualificazione inizia con la 26.06.
...
| Kubernetes (infrastruttura e cluster guest) | 1,36 


| KubeVirt | 1.9.0-beta.0 


| Importatore di dati containerizzato (CDI) | 1,65 
|===
.Punti da considerare:
...
.Installa Trident direttamente nel cluster guest:
...
=== Immagini container necessarie per Trident 26.06
...
* docker.io/netapp/trident-operator:26.06.0 (opzionale)
