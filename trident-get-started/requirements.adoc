...
* Versioni di cluster FAS, AFF o ASA r2 (iSCSI, NVMe/TCP e FC) locali con supporto limitato di NetApp. Vederelink:https://mysupport.netapp.com/site/info/version-support["Supporto della versione software"] .
